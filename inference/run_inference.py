...
def load_stacked_model(model_path):
    ...
    stacked_model.load_state_dict(torch.load(model_path, map_location=device, weights_only=True))
    stacked_model.eval()
...
def main():
    ...
    parser.add_argument('--gan_modelpath', type=str, default='../models/saved_models/best_stacked_model_refined.pth', help="GAN model filepath")
